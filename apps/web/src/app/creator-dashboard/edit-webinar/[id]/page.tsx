...
import { getWebinar, updateWebinar } from '@/lib/services/webinars';
...
export default function EditWebinar() {
  ...
  useEffect(() => {
    async function loadWebinar() {
      ...
      try {
        ...
        // Check if user owns this webinar
        if (webinar.createdBy !== user.uid && userProfile?.role !== 'admin') {
          setError('You do not have permission to edit this webinar');
          return;
        }
        ...
        setWebinarData({
          ...
          embedUrl: webinar.embedUrl || webinar.streamUrl || webinar.videoUrl || '',
          platform: webinar.platform,
          thumbnail: webinar.thumbnail || '',
          tags: webinar.tags,
          yearGroups: webinar.yearGroups,
          hostName: webinar.hostName || webinar.instructor || '',
          hostBio: webinar.hostBio || webinar.instructorBio || '',
          enableChat: webinar.enableChat,
          enableQA: webinar.enableQA,
          status: webinar.status,
        });

        if (webinar.embedUrl || webinar.videoUrl) {
          setUploadedFileName('Existing video/stream');
        }
      } catch (err) {
  ...
  const handleSave = async () => {
    ...
    try {
      await updateWebinar(webinarId, webinarData);
      ...
      setError('Failed to update webinar. Please try again.');
    } finally {
      setIsSaving(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      ...
      {success && (
        <div className="fixed top-4 right-4 z-50 bg-green-500 text-white px-6 py-4 rounded-lg shadow-lg flex items-center gap-3 animate-in slide-in-from-right">
          ...
          <div>
            <p className="font-semibold">Webinar updated successfully!</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h1 className="text-xl font-bold">Edit Webinar</h1>
                </div>
                <p className="text-sm text-muted-foreground">
                  Update your webinar details
                </p>
              </div>
            </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        {/* Content Upload/Link - HIGHLIGHTED FOR EASY EDITING */}
        <Card className="border-2 border-primary/50 shadow-lg">
          <CardHeader className="bg-primary/5">
            ...
            <CardDescription>
              {webinarData.type === 'live' 
                ? 'Update your Zoom, YouTube Live, or Vimeo Live embed URL'
                : 'Update your video or provide a new YouTube/Vimeo link'
              }
            </CardDescription>
          </CardHeader>
                  ...
                  <Input
                    placeholder={
                      webinarData.platform === 'zoom' 
                        ...
                        : 'https://vimeo.com/event/54877326/embed or https://vimeo.com/event/54877326'
                    }
                    value={webinarData.embedUrl}
                    onChange={(e) => updateWebinarData({ embedUrl: e.target.value })}
                  />
                  <p className="text-xs text-blue-600 dark:text-blue-400 mt-2">
                    💡 For Vimeo Live: Use the event URL or embed URL from your event settings
                  </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-2 border-dashed border-border rounded-lg p-8 text-center hover:border-primary transition-colors">
                    {isUploading ? (
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <p className="text-sm font-medium text-green-600 dark:text-green-400 mb-1">
                            {uploadedFileName === 'Existing video/stream' ? 'Video/Stream URL set' : 'Video uploaded successfully!'}
                          </p>
                      ...
                      <>
                        ...
                        <p className="text-sm font-medium mb-2">Upload New Video File</p>
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-card px-2 text-muted-foreground">Or update the link</span>
                    </div>
                  </div>
