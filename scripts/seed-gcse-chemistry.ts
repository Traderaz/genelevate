 ...
 * Run with: npx ts-node scripts/seed-gcse-chemistry.ts
 */
...
async function seedGCSEChemistry() {
  ...
  const course = {
    ...
    thumbnail: '/images/courses/gcse-chemistry.jpg', // You can add this later
    ...
    createdBy: 'system', // You can change this to an admin user ID
    published: true,
    featured: true,
    enrollmentCount: 0,
    rating: 0,
